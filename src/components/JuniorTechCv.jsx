...
const cvData = {
  ...
  summary: [
    "Application support technician and junior software engineer with hands on experience building, deploying, and supporting web applications. Background in high pressure operational environments with strong fault diagnosis, database querying, and user support skills. Trusted to resolve technical issues quickly, communicate clearly with non technical users, and maintain stable systems in live business environments."
  ],

  skills: {
    technical: [
      "Operating Systems: Configuration and troubleshooting of Windows & Android environments",
      "Databases: Writing SQL queries and managing data using MS SQL & MySQL",
      "Web Technologies: JavaScript (ES6+), React, Node.js, Express",
      "Hardware & POS: Installation, configuration, and fault diagnosis of terminals and kitchen printers",
      "Networking: Local connectivity troubleshooting and system fault isolation"
    ],
    core: [
      { 
        ...
        items: [
          ...
          "Full SDLC exposure: build, test, deploy, and support",
      ...
      { 
        ...
        items: [
          ...
          "Calm, systematic fault diagnosis under pressure",
          "Strong ownership, punctuality, and operational reliability",
          "Process improvement mindset focused on business continuity"
        ] 
      }
    ]
  },
  ...
  education: [
    {
      ...
      dates: "2024 – Present",
      description: [
        "Project based learning focused on real world application development and system support.",
        "Built and deployed full stack applications with emphasis on SQL structure, error handling, and maintainability.",
      ],
    },
  ],
  ...
  experience: [
    ...
    {
      role: "Property Manager / Technical Operations",
      company: "Gardenia Trust LTD",
      location: "Auckland",
      dates: "10/2024 – Present",
      description: [
        "Provided application support and database troubleshooting for a portfolio of 7 properties, using SQL queries to identify and resolve data issues.",
        "Delivered first line technical support for users, resolving system and hardware faults to minimise operational downtime.",
        "Maintained asset tracking systems and ensured on site hardware remained functional and correctly configured."
      ]
    },
    {
      role: "Executive Chef / Operations & Systems Lead",
      company: "Various Establishments",
      location: "New Zealand & Thailand",
      dates: "1995 – 2022",
      description: [
        "Led teams of 15+ in time critical environments requiring rapid issue resolution and clear communication.",
        "Acted as first responder for POS, printer, and local network issues, reducing service interruptions.",
        "Designed and improved operational systems to increase consistency, reliability, and efficiency across teams."
      ]
    }
  ],

  project: {
    name: "Fuel & Fire – Live Web Application",
    description: [
      "Designed and built a full stack web application using React, Node.js, Express, and MongoDB.",
      "Implemented structured data models, API endpoints, and error handling.",
      "Deployed and maintained a live production environment with ongoing debugging and improvements.",
      "Used Git/GitHub for version control and iterative feature development."
    ]
  }
};

// --- Components (layout unchanged, content improved) ---
...
const Section = ({ title, children }) => (
  <section className="break-inside-avoid">
    <SectionTitle title={title} icon="star" />
    {children}
  </section>
);
    ...
    <div className="min-h-screen bg-slate-100 p-4 sm:p-12 font-sans text-slate-900 print:bg-white print:p-0">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-2xl overflow-hidden border border-slate-200 print:shadow-none print:border-none print:max-w-none print:w-full">
        ...
        <main className="p-8 md:p-12 print:p-0 print:pt-4">
          ...
          {/* Technical Skills */}
          <section className="break-inside-avoid">
            <SectionTitle title="Technical Skills" icon="briefcase" />
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 print:gap-8 print:grid-cols-2">
              <div>
                <h3 className="text-lg font-bold text-slate-800 mb-3 uppercase tracking-tight print:text-sm">Technical Stack</h3>
          ...
          {/* Portfolio Project */}
          <section>
            <SectionTitle title="Portfolio Project" icon="external" />
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-5 break-inside-avoid print:bg-white print:border-slate-200 print:p-0">
              <h3 className="text-lg font-bold text-slate-900 mb-2">{project.name}</h3>
              <ul className="list-disc ml-6 text-slate-700 text-sm space-y-1.5 print:text-xs print:ml-4 print:space-y-1">
              ...
              <div className="mt-3 space-y-1 text-sm print:text-xs">
                <p>
                  ...
                  <a href={personal.liveApp} target="_blank" rel="noopener noreferrer" className="text-emerald-700 hover:underline">
                    {personal.liveApp}
                  </a>
                </p>
                <p>
                  <span className="font-semibold">Code:</span>{' '}
                  <a href={personal.projectRepo} target="_blank" rel="noopener noreferrer" className="text-emerald-700 hover:underline">
                    {personal.projectRepo}
                  </a>
                </p>
              </div>
            </div>
          ...
          {/* Education */}
          <section>
            <SectionTitle title="Education" icon="star" />
            <div className="space-y-4 print:space-y-3">
        ...
        <footer className="bg-slate-50 p-6 text-center text-sm text-slate-400 border-t border-slate-100 print:bg-white print:text-slate-500">
          Full portfolio and projects available at: <a href={`https://${personal.github}`} target="_blank" rel="noopener noreferrer" className="hover:underline">{personal.github}</a>
        </footer>
      </div>
    </div>
  );
