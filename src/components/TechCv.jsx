  ...
  experience: [
    {
      ...
      description: [
        "Maintained detailed inventory and records for a multi-location portfolio.",
        "Ensured accurate asset tracking and compliance.",
        "Organized and scheduled a network of service providers for efficient property maintenance.",
      ],
      isHighlight: true,
    },
    {
      ...
      description: [
        "Managed high-volume, quality-driven production standards during peak periods.",
        "Drove significant increases in customer retention through consistent quality control.",
      ]
    },
    {
      ...
      description: [
        "Maintained 99%+ quality standards through systematic control processes.",
        "Resolved customer feedback and special requests efficiently and professionally.",
      ]
    },
    {
      role: "Executive Chef / Sous Chef",
      company: "Various International & Local Resorts",
      location: "Thailand & Auckland",
      dates: "1995 - 2015",
      description: [
        "Managed large teams of up to 15+ staff and oversaw complex operational tasks.",
