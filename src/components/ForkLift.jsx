...
const cvData = {
  ...
  summary: [
    "Reliable and energetic professional with a strong work ethic and a zero incident safety record, transitioning from a successful career in high volume hospitality management into logistics and warehouse operations. Proven ability to remain calm under pressure and solve complex problems in fast paced environments. Committed to operational accuracy, health and safety compliance, and providing excellent service to support team output and efficiency."
  ],
  skills: {
    technical: [
